...
public class Main {
    public static void main(String[] args) throws SQLException {
        ...
        testAjouter(userService);

        // Test de la méthode afficher
        testAfficher(userService);

        // Test de la méthode modifier
        testModifier(userService);

        // Test de la méthode supprimer
        testSupprimer(userService);
    }
    ...
    public static void testAjouter(UserService userService) throws SQLException {
        ...
        User newUser = new User(1, "john@example.com", "password123", "john", "doe", "typemaladie", "specialite", "groupesanguin", "statuteligibilite", "token", "brochure", "ROLE_USER");
